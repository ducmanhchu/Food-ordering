                ...
                <Container className="pt-4 pb-2">
                    ...
                    <div className="d-flex text-secondary justify-content-between">
                        <div className="col-md-4">
                            <h5 className="text-secondary mt-2">Thông tin liên hệ</h5>
                        ...
                        <div className="col-md-4">
                            ...
                            <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16 "style={{marginRight:"8px"}}>
